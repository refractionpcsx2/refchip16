...
{
	sprintf_s(headingstr, "RefChip16 V1.41 FPS: %d Recompiler %s", fps, Recompiler ? "Enabled" : "Disabled");
	...
	switch(message)
	{
		...
		case WM_COMMAND :
		  ...
		  case ID_WINDOWX3:
			  ...
			  break;
		  case ID_ABOUT :
				 MessageBox(hWnd, "RefChip16 V1.41 Written by Refraction - Big thanks to the Chip16 devs for this :)", "RefChip16", 0);			 
			 break;
		  case ID_EXIT :
			 DestroyWindow(hWnd);
			 return 0;
